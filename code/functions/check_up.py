...
class check_up(commands.GroupCog, name="checkup"):
    ...
    async def view(self, interaction: discord.Interaction):
        ...
        # Check that the user has permission to view checkup
    ...
    async def start(self, interaction: discord.Interaction, member: discord.Member):
        ...
        # Check that the user has permission to start a checkup
        if await self.check_hr_roles(interaction):
    ...
    async def finish(self, interaction: discord.Interaction, member: discord.Member):
        ...
        # Check that the user has permission to finish a checkup
        if await self.check_hr_roles(interaction):
