...
class loa(commands.Cog, app_commands.Group, name="loa"):
    ...
    async def add(self, interaction: discord.Interaction, member: discord.Member, duration: int, reason: str):
        "Add LOA to a member"
        #Check if the user has one of the roles defined in the hr_roles table
        ...
        #If the user does not have one of the roles defined in hr_roles, send a message alerting the user
        else:
            embed = discord.Embed(
